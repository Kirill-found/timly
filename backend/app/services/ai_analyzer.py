...
5. **КАЛИБРУЙ АДЕКВАТНО** — оценка 5 редкая (идеальный кандидат), но не занижай оценки без причины
6. **ВЕРИФИЦИРУЙ ДАННЫЕ** — нереалистичный опыт (>15 лет в молодой индустрии) = red flag
7. **АДАПТИРУЙСЯ К ТИПУ ВАКАНСИИ** — для бухгалтеров/юристов/офис-менеджеров стабильность важнее, частая смена работы более критична; для IT/стартапов — наоборот
...
Обо мне: {about_text or 'Не указано'}
Сопроводительное письмо: {cover_letter or 'Не указано'}
...
## КРАСНЫЕ ФЛАГИ (учитывай, но не дисквалифицируй автоматически!):
- **Нереалистичный опыт** (>10 лет в WB/Ozon, >15 лет в e-commerce России)
- Частая смена работы БЕЗ логики (не просто >3 за 2 года, а без карьерного смысла) — НО для IT это нормально!
- Пробелы >12 мес без объяснения (6 мес — это нормально для поиска работы)
- Завышенные ЗП ожидания (>50% от вилки)
- Явное несоответствие заявленных навыков и опыта
