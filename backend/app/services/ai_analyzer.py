...
{{
  ...
  "strengths": [
    "Конкретный факт 1 (компания, период, цифры)",
    "Конкретный факт 2"
  ],

  "concerns": [
    "Конкретное сомнение 1",
    "Конкретное сомнение 2"
  ],

  "verdict": "Mismatch | Low | Medium | High",
  "verdict_reason": "Главная причина вердикта в 1-2 предложениях",

  "reasoning_for_hr": "Развёрнутое объяснение для HR почему этот кандидат подходит/не подходит. 3-5 предложений с конкретикой.",

  "interview_questions": [
    {{
      "question": "Конкретный вопрос",
      "checks": "Что проверяем этим вопросом"
    }}
  ],

  "salary_fit": {{
    "status": "в вилке | выше на X% | ниже | не указано",
    "comment": "комментарий если нужен"
  }}
}}
