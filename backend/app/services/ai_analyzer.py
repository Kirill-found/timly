...
STOP-WORDS (запрещено): "хороший кандидат", "подходит", "соответствует", "рекомендуется"

EVIDENCE CHECK: Каждый pro/con привязан к факту. Нет доказательства = не пиши.

❌ "Имеет опыт" → ✅ "Яндекс (3 года) — highload, Go"
❌ "Хороший кандидат" → ✅ "Сбер → Тинькофф: рост, T1-трек"
...
{{
  ...
  "pros": ["[Компания] — факт/достижение. 1-5 по мере наличия фактов"],
  "cons": ["[Риск] — почему критично. 1-5 по мере наличия фактов"],
  "red_flags": [],
  "yellow_flags": [],
